INSERT INTO USER (ID, ADDRESS, EMAIL_ADDRESS, FIRST_NAME, LAST_NAME, ROLE, SSN, USER_NAME) VALUES
	(101, 'Manchester', 'mike@test.com', 'Mike', 'Vas', 'admin', 'ssn101', 'mvas'),
	(102, 'Chester', 'micky@test.com', 'Micky', 'Test', 'admin', 'ssn102', 'mtest'),
	(103, 'London', 'luda@test.com', 'Luda', 'Chic', 'user', 'ssn103', 'lchi');
